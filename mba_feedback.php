...
if (!isset($_SESSION['user_email']) || !isset($_SESSION['course']) || $_SESSION['course'] !== 'MBA') {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($feedback === '') {
        ...
        $stmt = $conn->prepare("INSERT INTO feedback_mba (name, email, course, feedback) VALUES (?, ?, ?, ?)");
        $course = 'MBA';
...
<style>
  ...
  h2{color:#ff69b4;margin:0 0 14px}
  input,textarea{width:100%;padding:10px;border-radius:8px;border:none;margin-bottom:12px}
  textarea{height:110px;resize:none}
  button{background:#ff69b4;color:#000;border:none;padding:11px;border-radius:8px;font-weight:700;cursor:pointer;width:100%}
...
<body>
  <div class="card">
    ...
    <div class="small"><a href="logout.php" style="color:#ff69b4;text-decoration:none">Logout</a> • <a href="index.php" style="color:#ff69b4;text-decoration:none">Back Home</a></div>
  </div>
</body>
</html>
