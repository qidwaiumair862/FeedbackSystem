...
if (!isset($_SESSION['user_email']) || !isset($_SESSION['course']) || $_SESSION['course'] !== 'BBA') {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($feedback === '') {
        ...
        $stmt = $conn->prepare("INSERT INTO feedback_bba (name, email, course, feedback) VALUES (?, ?, ?, ?)");
        $course = 'BBA';
...
<style>
  ...
  h2{color:#00ffff;margin:0 0 14px}
  input,textarea{width:100%;padding:10px;border-radius:8px;border:none;margin-bottom:12px}
  textarea{height:110px;resize:none}
  button{background:#00ffff;color:#000;border:none;padding:11px;border-radius:8px;font-weight:700;cursor:pointer;width:100%}
...
<body>
  <div class="card">
    ...
    <div class="small"><a href="logout.php" style="color:#00ffff;text-decoration:none">Logout</a> • <a href="index.php" style="color:#00ffff;text-decoration:none">Back Home</a></div>
  </div>
</body>
</html>
